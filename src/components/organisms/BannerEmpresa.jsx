...
export const BannerEmpresa = () => {
  ...
  const countUsers = useCompanyStore((state) => state.countUsers);
  return (
    <Container>
      <div className="content-wrapper-content">
        ...
        <div className="content-text">Conoce el Inventario de tu empresa</div>
        <ContentCards>
          <CardDatosEmpresa
            titulo="Moneda"
            value={dataCompany?.simbolomoneda}
          />
          <CardDatosEmpresa titulo="Usuarios" value={countUsers} />
        </ContentCards>
      </div>
